...
export const SECTOR_DRIVER_PACKS: Record<SectorId, SectorDriverPack> = {
  ...
  "internet-platform": {
    revenueDrivers: ["search & digital advertising volume", "ad impressions & price per ad / CPC", "cloud infrastructure & enterprise backlog", "subscriptions & platforms"],
    costDrivers: ["data-center & AI infrastructure capex/opex", "traffic acquisition costs (TAC)", "content & YouTube rev-share", "R&D engineering talent"],
    capexDrivers: ["hyperscale data-center & custom silicon (TPU/GPU)", "network infrastructure & subsea cables"],
    nwcDrivers: ["advertiser receivables", "prepaid infrastructure capacity & vendor payables"],
    segments: ["Google Services (Search, YouTube, Network)", "Google Cloud", "Digital Advertising & Subscriptions", "Family of Apps"],
    kpis: ["Search Ad Revenue", "YouTube Ads", "Google Cloud / Backlog", "Traffic Acquisition Costs (TAC)", "DAU / MAU", "Ad Impressions", "Price per Ad / CPC", "Digital ARPU", "FCF Conversion"],
    risks: ["Ad-spend cyclicality", "AI search disruption & queries monetization", "Privacy & antitrust regulation", "AI infrastructure capex intensity"],
    catalysts: ["Cloud/GCP margin expansion", "AI-assisted ad ranking & monetization gains", "Gemini enterprise adoption", "Capital return via buybacks & dividends"],
    valuationMethods: ["FCFF_DCF", "EV_EBITDA", "MULTIPLES_PE"],
    requiredConcepts: ["search", "ad impressions", "advertising", "cloud", "arpu", "dau", "mau", "price per ad", "tac"],
