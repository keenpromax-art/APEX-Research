...
export const INTERNET_PLATFORM_PROFILE: SectorProfile = {
  ...
  name: "Internet Platform, Digital Advertising & Cloud Services",
  allowedKPIs: [
    "Search Advertising Revenue Growth",
    "YouTube Advertising Revenue Growth",
    "Google Cloud & Enterprise Backlog Growth",
    ...
    "Average Price per Ad Growth / Cost Per Click (CPC)",
    "Operating Margin",
    "Free Cash Flow Conversion",
  ...
  preferredValuationModels: ["FCFF_DCF", "EV_EBITDA", "MULTIPLES_PE"],
  financialMetrics: ["Search Advertising", "YouTube Advertising", "Google Cloud Revenue", "Subscriptions & Devices", "Operating Income", "Data Center & AI Capex", "Operating Cash Flow", "Free Cash Flow"],
  riskCategories: ["Digital Advertising Spend Cyclicality", "Search Query Disruption & AI Competition", "Data Privacy & Antitrust Regulation", "AI Infrastructure Capex Intensity"],
  moatDrivers: ["Global query scale and dominant search distribution", "Video engagement & creator network effects on YouTube", "Enterprise multi-cloud and proprietary AI infrastructure (TPU/TensorFlow/Gemini)", "Proprietary ad targeting data and bidding auction density"],
  forbiddenConcepts: [
